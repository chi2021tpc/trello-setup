...
def load_data_1(path):
    ...
    keys_to_be_deleted = [
        ...
        "Author 1 - id", "Author 1 - prefix", "Author 1 - first", "Author 1 - middle", "Author 1 - last", "Author 1 - suffix", "Author 1 - email", "Author 1 - dept/school/lab 1", "Author 1 - institution 1", "Author 1 - city 1", "Author 1 - state/prov 1",
        # "Author 1 - country 1",
        "Author 1 - dept/school/lab 2", "Author 1 - institution 2", "Author 1 - city 2", "Author 1 - state/prov 2", "Author 1 - country 2",
